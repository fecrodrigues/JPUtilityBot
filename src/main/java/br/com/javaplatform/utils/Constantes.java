...
public class Constantes {
	...
	//Mensagens do Dialogo 1
	public final static String MSG_DIALOGO1_1 = "Vou bem, mas poderia estar melhor com um \"Bom Dia!\" antes!";
	public final static String MSG_DIALOGO1_2 = "Nossa, quantas vezes eu vou precisar falar \"Bom Dia\"?";
	public final static String MSG_DIALOGO1_3 = "Esta tudo bem. Confesso que gostaria de sair de casa, mas tenho que respeitar a quarentena";
	public final static String MSG_DIALOGO1_4 = "Não tenho feito nada de novo recentemente, mas gostaria de viajar";
	public final static String MSG_DIALOGO1_5 = "Esta tudo OK";
	...
	public final static String MSG_DESPEDIDA_1 = "Nem começamos e você ja quer ir embora?";
	public final static String MSG_DESPEDIDA_2 = "Nossa o papo nem começou e você já quer sair. Lamentável isso.";
	public final static String MSG_DESPEDIDA_3 = "Se você não quer mais papo, pode ir embora";
	public final static String MSG_DESPEDIDA_4 = "Att";
	public final static String MSG_DESPEDIDA_5 = "Gostei da coversa. Boa semana";
}
